...
<div class="text-center text-danger">После восстановления пароля будет выполнен повторый запрос на разрешение работы.</div>
    ...
    <form method="POST" class="enter-form   col-12 col-md-4">
        <div class="form-group">
            ...
            <input type="number" name="login" value="" id="login-id" class="enter-field form-control" required />
              <small id="login-help" class="form-text text-muted">введите ИНН организации указанный при регистрации</small>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" value="" id="name-id" class="enter-field form-control" required />
                   <small id="login-help" class="form-text text-muted">введите имя/логин указанный при регистрации</small>
        </div>
